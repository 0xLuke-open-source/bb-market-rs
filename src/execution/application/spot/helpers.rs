...
use super::types::{
    ApiOrderRequest, OrderActionResult, ParsedOrderType, TraderOrderJson, TraderTradeJson,
};
...
pub(super) fn trader_order_from_view(
    view: &crate::execution::domain::matching::OrderView,
) -> TraderOrderJson {
    TraderOrderJson {
        time: now_text(),
