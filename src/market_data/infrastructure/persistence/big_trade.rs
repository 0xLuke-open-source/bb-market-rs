...
use crate::market_data::application::ports::{BigTradeReader, BigTradeSink};
use crate::market_data::application::{BigTradeHistoryRecord, BigTradeStatsRecord};
use crate::market_data::domain::stream::AggTrade;
...
impl BigTradeSink for BigTradePersistenceService {
    fn persist_big_trade(&self, trade: &AggTrade, threshold_quantity: f64) {
        self.submit_trade(BigTradeRecord::from_agg_trade(trade, threshold_quantity));
    }
}
...
#[async_trait]
impl BigTradeReader for BigTradeQueryService {
    async fn load_big_trades(
        ...
        BigTradeQueryService::load_big_trades(self, symbol, limit, from, to).await
    }
    ...
    async fn load_big_trade_stats(
        ...
        BigTradeQueryService::load_big_trade_stats(self, symbol, from, to).await
    }
}
    ...
    async fn ensure_schema(&self) -> Result<()> {
        ...
        client
            ...
            .batch_execute(include_str!(
                "../../../../sql/postgres/market_big_trade.sql"
            ))
            .await?;
        Ok(())
    }
